package com.qaregression.appium.framework.config;
...
public enum AppiumDriverType implements AppiumDriverSetup {
    ...
    ANDROID {
        public DesiredCapabilities getDesiredCapabilities(String pathToAppFile, boolean debug) {
            ...
            capabilities.setCapability(MobileCapabilityType.DEVICE_NAME, "Android device");
            capabilities.setCapability(MobileCapabilityType.APP, pathToAppFile);
            capabilities.setCapability(AndroidMobileCapabilityType.APP_PACKAGE, System.getProperty("app.package.name"));
            capabilities.setCapability(AndroidMobileCapabilityType.APP_ACTIVITY, System.getProperty("app.main.activity"));
